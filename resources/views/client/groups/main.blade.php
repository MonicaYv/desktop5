        ...
        $(document).ready(function() {
            ...
            populateTable();
             ...
             function populateTable(searchTerm = '', page = 1, clientId = '') {
                const listroute = @json(route('client.group.list'));
                $.ajax({
                    url: listroute,
                    method: 'GET',
                    data: {
            ...
            $('.addgroupmodel').on('click', function() {
                const addGroupRoute = @json(route('client.group.add')); 
            ...
            $(document).on('click', '#searchableTableBody .editGroupModal', function(e) {
                const editGroupRoute = @json(route('client.group.edit')); 
            ...
            $('#okdelete').on('click', function() {
                ...
                let deleteRoute = @json(route('client.group.delete')); // Route to delete the group
