...
//     return Route::get('/dots/livewire/livewire.js', $handle);
// });
// Livewire::setUpdateRoute(function ($handle) {
//     return Route::post('/dots/livewire/update', $handle);
// });

// Route::get('/dots/livewire/livewire.js', function () {
//     return response()->file(public_path('livewire/livewire.js'));
// });
// Route::get('/install', Installer::class)->name('install.index');

// Route::middleware([\App\Http\Middleware\CheckInstallation::class])->group(function () {
    ...
    Route::middleware(['blockIP'])->group(function () {
        ...
        Route::middleware(['auth'])->group(static function () {
            Route::middleware([CheckPermission::class])->group(function () {
                ...
                Route::put('client/users/update/{id}', [UserController::class, 'update'])->name('client.user.update');
                ...
                Route::put('client/company/users/update/{id}', [UserController::class, 'update'])->name('client.company.user.update');
            ...
            //// Routes without permission auth
